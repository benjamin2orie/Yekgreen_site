        ...
        <div className={ styles.container}>
            ...
            <div className={styles.container_section}>
                <section className={ styles.section_bg}>
                    ...
                    <p className={styles.para2}>Ranging from meals to desert to drinks</p>
                    <div className={ styles.search_recipes}>
                        <input type='text' placeholder='Serach recipe'/><br/>
                        <button className={styles.btn}><AiOutlineSearch/></button>
                    </div>
                </section>
